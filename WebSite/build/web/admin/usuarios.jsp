                                                        ...
                                                        <form action="config/editarUsuario.jsp?id=<%out.print(id);%>" method="POST"> 
                                                          <div class="modal-body">
                                                                  ...
                                                                  <div class="mb-3">
                                                                    ...
                                                                    <input type="email" name="email" value="<%= rs.getString(3) %>" class="form-control" id="exampleFormControlInput1" placeholder="Email">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label">Telefone:</label>
                                                                    <input type="text" name="telefone" value="<%= rs.getString(4) %>" class="form-control" id="exampleFormControlInput1" placeholder="Telefone (00)0000-0000">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label">Senha:</label>
                                                                    <input type="password" name="senha" value="<%= rs.getString(5) %>" class="form-control" id="exampleFormControlInput1" placeholder="Senha">
                                                                  </div>            
                                                          </div>
