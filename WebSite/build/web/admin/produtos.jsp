            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <hr>
                        <form action="config/cadastraProdutos.jsp" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="desc" placeholder="Digite a Descrição Do Produto">            
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Envie a Imagem Do Produto:</label>
                                       ...
                                       try{
                                            ...
                                            %>
                                             <tr>
                                                    ...
                                                    <td> <img src="../arquivos/<%=rs.getString(5) %>" alt="Product Image" width="80px" height="80px"/> </td>
                                                    <td>
                                                ...
                                                <!-- Modal Editar -->
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <form action="config/editarProduto.jsp?id=<%out.print(id);%>&<%out.print(imagem);%>" method="POST"> 
                                                          <div class="modal-body">
                                                                  <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label">Nome:</label>
                                                                    <input type="text" name="nome" value="<%=rs.getString(2)%>" class="form-control" id="exampleFormControlInput1" placeholder="Nome">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label">Descrição:</label>
                                                                    <input type="text" name="desc" value="<%= rs.getString(3) %>" class="form-control" id="exampleFormControlInput1" placeholder="Email">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label">Valor:</label>
                                                                    <input type="text" name="valor" value="<%= rs.getString(4) %>" class="form-control" id="exampleFormControlInput1" placeholder="Telefone (00)0000-0000">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                    <label class="form-label">Atualize a Imagem:</label>
                                                                    <input type="file" class="form-control" name="files[]" multiple /> 
                                                                  </div>            
                                                          </div>
                                ...
                                <%
                                    if(request.getParameter("funcao") != null && request.getParameter("funcao").equals("excluir")){
                                        ...
                                        try{
                                            ...
                                            response.sendRedirect("usuarios.jsp?erro=7");//ERRO 7 = USUARIO DELETADO COM SUCESSO
                                        } catch(Exception e){
                                            out.println(e);
                                        }
                                    }
